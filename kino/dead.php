	...
	<div class="main">
		...
		<div class="site_content">
			...
			<div class="content">
				...
				<iframe width="560" height="315" src="https://www.youtube.com/embed/zIjSaeBp974?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>					<div class="info_film_page">
				...
				<div class="descriptions_film">
					<img width="100" src="assets/img/dead.png">
					После зомби-апокалипсиса многие выжившие борются за выживание. В поисках безопасности и уклонения от нежити они вынуждены бороться с соперничающими группами и трудным выбором.
				</div>
				...
				<form name="comment" action="/kino/php/comment.php" method="post">
				  ...
				  <p>Комментарий:
				    ...
				    <input type="hidden" name="page_id" value="154" />
