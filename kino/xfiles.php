	...
	<div class="main">
		...
		<div class="site_content">
			...
			<div class="content">
				...
				<iframe width="560" height="315" src="https://www.youtube.com/embed/3oOAMoAKdMo?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>					<div class="info_film_page">
					<span class="label">рейтинг: </span><span class="value">8.2 / 10</span>
					<span class="label">год: </span><span class="value">1993</span>
					<span class="label">режиссер: </span><span class="value">Дэвид Духовный</span>
				</div>
				<hr>	
				<h2>Описание Секретные материалы</h2>
				<div class="descriptions_film">
					<img width="100" src="assets/img/xfiles.png">
					Теоретик заговора Фокс Малдер и реалист Дана Скалли делают все возможное в качестве специальных агентов ФБР, чтобы расследовать и докопаться до сути необъяснимых паранормальных явлений.
				</div>
