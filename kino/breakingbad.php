	...
	<div class="main">
		...
		<div class="site_content">
			...
			<div class="content">
                ...
                <iframe width="560" height="315" src="https://www.youtube.com/embed/L5l3vv9n7EU?controls=0" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>					<div class="info_film_page">
				...
				<div class="descriptions_film">
					<img width="100" src="assets/img/breakingbad.png">
					Уолтер Уайт, учитель химии, обнаруживает, что у него рак, и решает заняться бизнесом по производству метамфетамина, чтобы погасить свои медицинские долги. Его приоритеты начинают меняться, когда он становится партнером Джесси.
				</div>
